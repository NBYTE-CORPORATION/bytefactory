  ...
  return (
    <div className={`sidebar ${isOpen ? "open" : ""}`}>
      ...
      >
        ...
        {/* 이곳에 홈 아이콘 SVG 또는 Font Awesome 아이콘을 사용할 수 있습니다 */}
        <span>텍스트 비교</span>
      </div>
      <div
        className={
          headerTitle === "ClipboardMonitor"
            ? "sidebar-item click-item"
            : "sidebar-item"
        }
      ...
      <div
        className={
          headerTitle === "SiteCollection"
            ? "sidebar-item click-item"
            : "sidebar-item"
        }
        onClick={() => handleItemClick("/SiteCollection", "SiteCollection")}
      >
        <i className="icon-messages"></i>{" "}
        {/* 이곳에 메시지 아이콘 SVG 또는 Font Awesome 아이콘을 사용할 수 있습니다 */}
        <span>사이트모음</span>
